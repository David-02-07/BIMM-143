...
\urlstyle{same}
\hypersetup{
  pdftitle={week03\_class05.R},
  pdfauthor={David Alvarez},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{week03\_class05.R}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Week 3 Data Visualization Lab 5}
...
\CommentTok{\# A quick base R plot {-} not ggplot}
\FunctionTok{plot}\NormalTok{(cars)}
\end{Highlighting}
\end{Shaded}

\includegraphics{week03_class05_files/figure-latex/unnamed-chunk-1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# First ggplot}
\CommentTok{\# Need data + aes + geoms}
...
\includegraphics{week03_class05_files/figure-latex/unnamed-chunk-1-2.pdf}
...
\includegraphics{week03_class05_files/figure-latex/unnamed-chunk-1-3.pdf}
...
\includegraphics{week03_class05_files/figure-latex/unnamed-chunk-1-4.pdf}
...
\includegraphics{week03_class05_files/figure-latex/unnamed-chunk-1-5.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q. How many columns are in this dataset}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q. How many \textquotesingle{}up\textquotesingle{} regulated genes}
...
\includegraphics{week03_class05_files/figure-latex/\#-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Adding color}
...
\NormalTok{g }\SpecialCharTok{+} \FunctionTok{scale\_color\_manual}\NormalTok{( }\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"gray"}\NormalTok{, }\StringTok{"red"}\NormalTok{)) }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=} \StringTok{"Gene expression Changes Upon Drug Treatment"}\NormalTok{, }\AttributeTok{x=}\StringTok{"Control (no drug)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Drug Treatment"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{week03_class05_files/figure-latex/\#-2.pdf}
